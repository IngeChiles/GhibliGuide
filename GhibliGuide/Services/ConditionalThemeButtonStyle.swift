//  ConditionalThemeButtonStyle.swift
//  GhibliGuide
...
/// Custom button that accomodates both light mode and dark mode.
struct ConditionalThemeButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            .padding()
            .background(colorScheme == .dark ? Color.forest : Color.oakLeaf)
